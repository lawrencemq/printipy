...
class TestPrintiPyApiV1(TestCase):
	...
	def prepare_response(
		self,
		http_type: Union[responses.GET, responses.POST, responses.DELETE, responses.PUT],
		url: str,
...
class TestPrintiPyOrdersApiV1(TestPrintiPyApiV1):
	...
	def test_create_order_with_sku(self):
		...
		self.assertEqual(
			self.api.orders.create_order_with_sku(CreateOrderBySku.from_dict(data_for_url)),
			data_returned_from_url['id'],
		)
		self.assertEqual(
	...
	def test_cancel_order(self):
		...
		self.assertEqual(
			self.api.orders.cancel_order('5dee261dc400914833007902', shop_id=self.shop_id),
			Order.from_dict(data_returned_from_url),
		)
